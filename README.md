...
|  이름  | 역 할  |   세부 역할    | Github         |
| :----: | :----: | :------------: | :------------- |
| 우재현 |  팀장  | 디렉토리 구조 설계, 데이터분석, 산출물 정리, 모델(LGBM) 학습 및 평가, db연동 | [@Wjaehyun](https://github.com/Wjaehyun) |
...
---
## 💬 **팀원 소감**
- 👑 **우재현** : 최근에 배운 머신러닝을 사용하다보니 계획한 작업 순서 중에 놓치는 순서가 있어서 재작업하느라 시간 소요가 더 있었던 것 같습니다. 때문에 많은 기능을 구현하지 못함에 아쉬움이 남으나, 동시에 머신러닝을 통해 얻을 수 있는 정보로 여러가지가 가능하다라는 사실을 체감하는 프로젝트였습니다.
...
- 😀 **안혜빈** : 지금까지 배운 내용들을 적용해 볼 수 있어 좋은 경험이었다. 
실제로 적용하면서 부족한 부분이나 스스로 학습이 더 필요한 부분을 쉽게 파악할 수 있었다. 
프로젝트 진행하면서 효율적인 운영을 위해 다양한 머신러닝 모델을 학습하고 평가 할 수 있어 좋았다. 
...
- 🤖 **조남웅** : streamlit 구현 담당은 2번째여서 1차때보단 쉬웠지만 퀄리티가 많이 낮은 거 같아 아쉬움이 더 큽니다.
또한, 머신러닝과 딥러닝 지식이 부족하여 더 학습하려는 자세를 가져야겠으며 고생한 팀원들께 감사를 보냅니다.