...
결측치 처리 방법으로 
KNN, SimpleImputer - Frequent, SimpleImputer - Median, 0으로 대치
4가지 방법을 적용해서 각 모델별로 테스트 한 결과 SimpleImputer - Median이 가장 성능이 좋았음.
Xgboost가 평가 지표가 가장 좋음
F1-score가 0.765 으로 다른 모델들에 비해 가장 좋았고,
